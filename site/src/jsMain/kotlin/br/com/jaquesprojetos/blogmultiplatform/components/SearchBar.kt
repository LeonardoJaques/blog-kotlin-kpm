        ...
        Row(
            modifier = modifier
                ...
                .border(
                    ...
                    color = when {
                        focused && !darkTheme -> Theme.Primary.rgb
                        focused && darkTheme -> Theme.Primary.rgb
                        !focused && !darkTheme -> Theme.LightGray.rgb
                        !focused && darkTheme -> Theme.Secondary.rgb
            ...
            Input(
                ...
                attrs = Modifier
                    ...
                    .fillMaxSize()
                    .color(
                        if (darkTheme) Theme.White.rgb
                        else Theme.Black.rgb
                    )
